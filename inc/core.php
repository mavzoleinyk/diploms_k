...
function lucida_scripts() {
	...
	wp_enqueue_script( 'lucida-navigation', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/navigation.min.js', array(), LUCIDA_THEME_VERSION, true );

	wp_enqueue_script( 'lucida-skip-link-focus-fix', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/skip-link-focus-fix.min.js', array(), LUCIDA_THEME_VERSION, true );
	 ...
	 */
	if ( 'dark' == $options['color_scheme'] ) {
		wp_enqueue_style( 'lucida-dark', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/colors/dark.css', array(), LUCIDA_THEME_VERSION );
	}
	...
	if ( ! $options['disable_scrollup'] ) {
		wp_enqueue_script( 'lucida-scrollup', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/scrollup.min.js', array( 'jquery' ), '20072014', true  );
	}

	/**
	 * Enqueue custom script for Lucida.
	 */
	wp_enqueue_script( 'lucida-custom-scripts', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/custom-scripts.min.js', array( 'jquery' ), null );
	...
	// Load the html5 shiv.
	wp_enqueue_script( 'lucida-html5', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/html5.min.js', array(), '3.7.0' );
...
if ( ! function_exists( 'lucida_single_content_image' ) ) :
	...
	function lucida_single_content_image() {
		...
		if ( ( 'disabled' == $individual_ft_image  || '' == get_the_post_thumbnail() || ( $individual_ft_image=='default' && 'disabled' == $featured_image ) ) ) {
